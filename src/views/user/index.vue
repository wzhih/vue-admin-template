  ...
  <div class="app-container">
    <div class="title-container">
      <router-link :to="{name:'UserAdd'}">
        <el-button v-permission="`user/add`" class="filter-item" type="success">新增用户</el-button>
      </router-link>
    </div>
    <el-table
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="300">
        <template slot-scope="scope">
          <el-button v-permission="`user/update`" type="primary" size="small" @click="edit(scope.$index, scope.row)">编辑</el-button>
          <el-button v-permission="`user/delete`" type="danger" size="small" @click="del(scope.$index, scope.row)">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
